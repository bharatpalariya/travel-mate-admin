/*
  # Final Admin Role System

  This migration creates a comprehensive admin role system that:
  1. Only shows users with role: "admin" in raw_user_meta_data
  2. Properly detects admin users during authentication
  3. Provides debug capabilities for troubleshooting
